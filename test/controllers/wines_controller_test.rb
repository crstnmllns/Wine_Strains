...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { qualification: @wine.qualification, trademark: @wine.trademark } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { qualification: @wine.qualification, trademark: @wine.trademark } }
