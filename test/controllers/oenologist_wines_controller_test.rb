...
class OenologistWinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oenologist_wine" do
    assert_difference('OenologistWine.count') do
      post oenologist_wines_url, params: { oenologist_wine: { oenologist_id: @oenologist_wine.oenologist_id, wine_id: @oenologist_wine.wine_id } }
    end
  ...
  test "should update oenologist_wine" do
    patch oenologist_wine_url(@oenologist_wine), params: { oenologist_wine: { oenologist_id: @oenologist_wine.oenologist_id, wine_id: @oenologist_wine.wine_id } }
